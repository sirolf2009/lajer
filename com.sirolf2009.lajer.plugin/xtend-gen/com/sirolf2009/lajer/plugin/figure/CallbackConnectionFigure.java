...
public class CallbackConnectionFigure extends PolylineConnection {
  private final PortFigure from;
  
  private final OperationOutputFigure to;
  
  public CallbackConnectionFigure(final PortFigure from, final OperationOutputFigure to) {
    this.from = from;
    this.to = to;
  ...
  public PortFigure getFrom() {
    return this.from;
  }
  
  public OperationOutputFigure getTo() {
    return this.to;
  }
}
